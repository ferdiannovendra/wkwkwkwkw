...
const invokeTransaction = async (channelName, chaincodeName, fcn, args, userName, orgName,) => {
  ...
  console.log("Identity nya : "+ identity);
  if (!identity) {
    console.log(
  ...
  console.log("connectionOptions nya : "+ connectionOptions);
